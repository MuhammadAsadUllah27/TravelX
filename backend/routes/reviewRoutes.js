...
// GET request to fetch reviews for a specific destination
// Route Example:
// /reviews/destination/Dubai
//
// controller.getReviewsByDestination:
// Returns reviews based on destination name
router.get(
